package bilet.client;

import basket.network.objectprotocol.BasketServicesObjectProxy;
import bilet.client.gui.BiletClientCtrl;
import bilet.client.gui.LoginWindow;
...
public class StartObjectClient {
    ...
    public static void main(String[] args) {
        ...
        IBiletServices server=new BasketServicesObjectProxy(serverIP, serverPort);
        BiletClientCtrl ctrl=new BiletClientCtrl(server);
